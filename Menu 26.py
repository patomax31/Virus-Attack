...
def play():
    while True:
        ...
        Level_two = Button(image=None, pos=(850, 250), 
                            text_input="NIVEL", font=get_font(75), base_color="White", hovering_color="Green")
...
def main_menu():
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("boton.png"), pos=(640, 250), 
                            text_input="PLAY", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("boton.png"), pos=(640, 550), 
